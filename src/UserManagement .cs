...
namespace 图书管理系统
{
    public partial class UserManagement : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("已授予过用户" + usersDGV.CurrentRow.Cells[2].Value.ToString() + "管理权限了，", "注意");
            }
            else
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("用户" + usersDGV.CurrentRow.Cells[2].Value.ToString() + "不是管理员，无法回收管理权限，", "注意");
            }
            else
            {
